...
| Structure fine (inv.) | $A_{\alpha_U}^{\mathrm{fp}}=\alpha_{\mathrm{root}}^{-1}+\alpha_U(P_C)$ | valeur comparative sans hadrons à provenance mixte 137.03595950081728 ; valeur racine côté source 136.99483516462165 ; $P_C$ est le pixel de comparaison CODATA | 137.035999177(21) | écart CODATA moins comparaison : 0.00003967618 en unités d'alpha inverse ; le statut côté source exige le calcul OPH-QCD/hadronique du point final dans le même schéma |
