...
| Secteur électrofaible massif et Higgs (W, Z, Higgs, top) | $W,Z,H,t$ | dérivation conditionnelle : les couplages fixés par le pixel et la surface électrofaible déclarée fixent la branche, puis la carte de masse calcule la paire sans qu'aucune masse mesurée n'entre. Loi de valeurs sans cible $(m_W,m_Z)=(80.3770000154,\,91.1879780779)$ GeV ; surface déclarée $(m_H,m_t)=(125.1995304097,\,172.3523553288)$ GeV ; aucune masse physique fermée côté source n'est émise | $m_W=80.3692(133)$, $m_Z=91.1880(20)$, $m_H=125.13(11)$, $m_t=172.1(6)$ GeV | la paire de la loi de valeurs est une conséquence exacte de cinq prémisses finies de transport sur le quotient dont le certificat n'est pas émis ; la paire Higgs/top vaut sur la surface déclarée de running, d'appariement et de seuils dont les couplages centraux et les pentes du jacobien sont des entrées de calibration déclarées ; les portes d'échelle physique, de schéma, de branche, de provenance, d'incertitude et de pôle complexe sont ouvertes |
| Leptons chargés (électron, muon, tau) | $e,\mu,\tau$ | aucune masse physique non nulle fermée côté source n'est émise : le porteur icosaédrique par faces et sommets fixe la structure de famille, mais l'application vers les masses absolues reste ancrée sur les cibles | coordonnées de comparaison conservées hors de ce registre | le témoin exact de famille est ancré sur les cibles et vit dans les surfaces d'audit ; la sélection physique de source est ouverte |
| Spectre des quarks (up, down, strange, charm, bottom, top) | $u,d,s,c,b,t$ | aucune masse physique non nulle fermée côté source n'est émise : les équations sources produisent deux rayons de profil Yukawa ordonnés mais laissent leurs étalements libres | Yukawa à échelle commune employés seulement pour l'audit | les équations sources laissent une non-identifiabilité à deux modules prouvée ; l'objet manquant est un sélecteur d'orbite de saveur dérivé de la source |
