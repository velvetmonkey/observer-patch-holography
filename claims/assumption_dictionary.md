...
| `transportable_sector_category` | At each fixed stage, the visible zero-obstruction seed carriers generate the full replete additive Karoubi rigid tensor subcategory of finite-dimensional boundary-group representations. | Compact SM/GR paper |
| `compact_gauge_refinement_receipt` | A cofinal tail supplies finite-state extendability, explicit center-compatible block-multiplicity embeddings, coherent surjective compact-group maps, transport compatibility, and composition receipts. | Compact SM/GR paper |
