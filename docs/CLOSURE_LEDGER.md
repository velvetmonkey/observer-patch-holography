...
| CL-3 | One capacity (SL-4): N_EW = π·exp(6π/(P·α_U)) vs N from Λ | exact only after F and premises CP-1 to CP-3 are discharged | conditional bridge value 3.53×10¹²² vs nominal Λ-readout value 3.31×10¹²²; F and CP-1 to CP-3 are open | nominal 6.6×10⁻²; propagated posterior places it at 2.4 to 2.5 one-dimensional sigma (consumed combination), 3.8 to 3.9 under Planck+BAO (code/capacity_readback/planck_posterior/) | not evaluated; conditional on F and CP-1 to CP-3 | construct F unconditionally, discharge CP-1 to CP-3, and freeze the likelihood combination (SLP-04) |
| CL-4 | Hierarchy bridge at the one N: α_U·log(N/π) = 6π/P | conditional on the same capacity premises | nominal 11.5546 vs 11.5573 at the Λ-located N | nominal 2.3×10⁻⁴ (log scale); propagated posterior recorded with CL-3 | not evaluated | same object as CL-3 |
