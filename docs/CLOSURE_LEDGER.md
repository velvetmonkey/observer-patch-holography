...
current residuals. The proof spine that consumes these rows is [PROOF_SPINE.md](PROOF_SPINE.md). This table is the primary evidential surface of the program: under
SL-0, a closure residual is a measurement of the hypothesis. Rows are permanent; verdicts
append. Last recomputed: 2026-07-15 (manual; CI regeneration is fix item SLP-02).
