...
It is tempting to identify the correction with the finite-screen unified gauge-width contribution
...
Informally: the source calculation lands short by a small number with a known physical meaning. The source plus finite-screen unified gauge-width result is the OPH no-hadron prediction. Adding the hadronic correction calibrated from the measured value lands on the CODATA/NIST central value. It does not predict extra digits, because the hadronic part has not been derived mathematically inside OPH.
