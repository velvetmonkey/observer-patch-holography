...
a chiral regular-\(C_3\) carrier
and faithful trace-preserving recoverable source-to-physical maps that
intertwine the block records and identify the physical GNS vector with
\(C=(Y_e^\dagger Y_e)^{1/4}\). Kadison--Schwarz makes such maps
\(L^2\)-isometric. Construction of the carrier, maps, refinement law,
positive chamber, and mass-scheme descent is work in progress. No \(12/24\)
receipt supplies that physical attachment.
