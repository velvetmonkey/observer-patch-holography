...
seen from within. Principle SL-2 of the strange-loop principle set (\texttt{../docs/STRANGE\_LOOP\_PRINCIPLES.md})
...
\texttt{../docs/STRANGE\_LOOP\_PRINCIPLES.md} and are cited here rather than restated. Principle SL-2
...
(\texttt{../docs/CONSISTENCY\_STACK.md}), the detuning law is row C6: after C1--C5
...
(\texttt{../docs/CONSISTENCY\_STACK.md}) states the interval form of assumptions
