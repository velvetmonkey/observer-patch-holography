...
\infobox{Sixteen quantitative comparisons}{
...
\(B(\mathcal V_K\otimes\mathbb C^2)\simeq M_6(\mathbb C)\). The event
\[
...
\]
This proves \(Q=2/3\) for the stated finite packet. An unconditional OPH
derivation requires proofs that Minimal Admissible Realization selects this
packet, that OPH supplies a chiral regular-\(C_3\) charged-lepton carrier, and
that trace-preserving recoverable maps with a left inverse attach the two
records to its GNS vector \(C=(Y_e^\dagger Y_e)^{1/4}\). Record intertwining
then makes the attachment an \(L^2\) isometry by Kadison--Schwarz. The physical
carrier, attachment, positivity, and mass-scheme descent are work in progress
