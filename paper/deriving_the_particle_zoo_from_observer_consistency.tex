...
count as declared branch architecture. A
...
an RG/coarse-graining naturality statement showing that radiative corrections preserve the
selected normal-form readout up to scheme-coordinate changes. The relation is a
continuation target connecting \(\mathcal R_U\) and \(\mathcal R_N\). The promoted hierarchy
row does not use it as an input.
