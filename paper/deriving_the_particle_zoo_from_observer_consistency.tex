...
the intrinsic neutrino-side basis. Ascending singular-value sorting does not select the physical
normal or inverted mass-eigenstate labels.
\end{theorem}
...
\]
and the corresponding intrinsic singular-vector basis with no PMNS import and no flavor-label
leakage. The physical normal-ordering assignment is
