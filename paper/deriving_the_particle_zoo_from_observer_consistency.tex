...
scale-covariant extension of \(N=\pi(r/\ell)^2\) and a declared identification rather than a
...
theorem-grade promotion of the resonance relation requires the finite-machinery
...
coordinates rather than the selected normal-form readout. The relation is a
