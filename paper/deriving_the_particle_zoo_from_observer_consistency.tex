...
row. The selected-class quark theorem carries only a target-anchored audit witness under the
strict public-output policy.
...
\midrule
Up quark & selected-class audit witness & withheld & selected public quark frame class \(f_P\) \\
Down quark & selected-class audit witness & withheld & selected public quark frame class \(f_P\) \\
Strange quark & selected-class audit witness & withheld & selected public quark frame class \(f_P\) \\
Charm quark & selected-class audit witness & withheld & selected public quark frame class \(f_P\) \\
Bottom quark & selected-class audit witness & withheld & selected public quark frame class \(f_P\) \\
Top quark & selected-class audit witness & withheld & selected public quark frame class \(f_P\) \\
\bottomrule
\end{tabular}
\end{table}
...
three-point quadratic readout realizes the target-anchored running quark sextet as an audit
witness, and the exact forward construction emits explicit exact forward Yukawas \(Y_u\) and
\(Y_d\) on that selected public class. The selected-class audit/support surface can be written as
\[
\!f_P
\Longrightarrow
