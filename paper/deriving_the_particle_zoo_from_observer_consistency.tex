...
Electroweak \(W/Z\) & conditional target-free derivation: value law \((m_W,m_Z)=(80.3770000154,\,91.1879780779)\)~GeV, scale-free ratio \(m_W/m_Z=0.8814429458\); no source-only physical mass emitted & the value-law pair is an exact implication of the QT1--QT5 quotient-transport premises, whose carrier certificate is unemitted; the base-running chart and the target-anchored freeze-once adapter are separate audit objects; no promoted pole pair \\
...
Higgs/top relation & conditional split coordinates \((m_H,m_t)=(125.1995304097,\,172.3523553288)\)~GeV, scale-free ratio \(m_H/m_t=0.7264161268\), on the declared running, matching, and threshold surface; no source-only physical mass emitted & the declared surface carries its core couplings and Jacobian slopes as calibration inputs; the source-root, scale, transport, rigidity, provenance, uncertainty, and complex-pole gates are open \\
...
Electroweak bosons & exact chart plus conditional quotient-transport theorem and comparison adapter & selected carrier \(\rightarrow\) two-coordinate mass chart; QT1--QT5 \(\Rightarrow\) unique value law & no nonzero mass in the prediction ledger; conditional target-free value-law coordinates \((m_W,m_Z)=(80.3770000154,\,91.1879780779)\)~GeV with \(m_W/m_Z=0.8814429458\); the base-running and freeze-once adapter charts stay in the audit discussion & QT1--QT5 are not derived from the finite carrier; no complex-pole receipt is emitted \\
...
Higgs/top stage & conditional downstream split theorem on the declared running, matching, and threshold surface + benchmark exact sidecar & gauge core followed by the candidate repair chart, the shared scalar \(\rho_{HT}=\log(1+\tau_{2,\mathrm{tree}}^{\mathrm{exact}})\), the split selectors, and the Jacobian readout & no nonzero mass in the prediction ledger; conditional split coordinates \((m_H,m_t)=(125.1995304097,\,172.3523553288)\)~GeV with \(m_H/m_t=0.7264161268\) on the declared surface; the inverse sidecar stays in technical audit prose & Strict promotion inherits the source-root, physical-scale, QT1--QT5, RG/scheme, rigidity, provenance, and complex-pole gates.\newline The companion top coordinate is not a separate public top-mass prediction row. \\
