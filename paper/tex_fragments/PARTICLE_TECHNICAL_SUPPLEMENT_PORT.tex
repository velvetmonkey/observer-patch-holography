...
This appendix records the finite simulator-facing certificate for
...
chart-naturality residuals are included. Simulator record IDs are not inputs.
...
is present, the terminal status is \(\mathrm{H3\_INTERACTION\_REQUIRED}\) and the event is handed
