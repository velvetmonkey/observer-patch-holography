...
\]
The sector-projector part of this map is the injection
\(\jmath_{rs}^{B}\) constructed in
Theorem~\ref{thm:refinement-functor-fiber-descent}; the holonomy and readback parts are its
coarse-shadow extension. The maps preserve isotony and obey
\[
...
does not assume prelimit injectivity of the full cylinder map.
